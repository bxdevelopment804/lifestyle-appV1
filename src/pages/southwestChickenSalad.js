...
const SouthwestChickenSalad = () => {
	...
	const section = 'Weight Loss Recipes';
	const mealType = 'Salad';
	const cuisineType = 'American';
	const mealTitle = 'Southwest Chicken Salad';
	const altText = 'southwest chicken salad';
	...
	const smallRecipePhoto =
		'https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2020/07/Southwest-Chicken-Salad-6-450x450.jpg';
	const recipePhoto =
		'https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2020/07/Southwest-Chicken-Salad-5.jpg';
	const recipePhoto2 =
		'https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2020/07/Southwest-Chicken-Salad-1.jpg';
	const recipePhoto3 =
		'https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2020/07/Southwest-Chicken-Salad-3.jpg';
	const recipeDate = 'July 31, 2020';
	const recipeDescription =
		'Southwest chicken salad is a hearty “main dish” kind of salad with bold flavors.';
	const title2 =
		'With a few pantry staples and fresh ingredients, this recipe comes together easily';
	const title3 =
		'A generous drizzle of creamy avocado dressing ties it all together';
	const description1 =
		'As you can tell, Southwestern flavors have a special place in my heart. Which is probably why I always find myself making chicken fajitas or stuffed peppers. The blend of earthy and bold flavors turns the simplest meals into an exciting one.  And this southwest chicken salad is just that. Crisp greens get topped with juicy spiced chicken, sweet corn, hearty black beans, juicy tomatoes, and creamy avocado dressing. Let’s just say this will have your taste buds craving for more. So don’t forget to make extra chicken!';
	const description2 =
		'While I love adding avocado slices to my salads, a drizzle of this creamy avocado dressing creates the same flavor – but better. Think of it as my all time favorite guacamole recipe, but in a liquid form that makes it easy to pour onto salads or macro bowls.  When your chicken is almost done marinating, quickly blend together the ingredients in a food processor. Then set aside for later.';
	const prepTime = '6hrs 10 mins';
	const cookTime = '10 mins';
	const totalTime = '6 hrs 20 mins';
	...
	return (
		<div id='pageContainer'>
			<div id='sectionTitle'>{section}</div>
				...
				<div id='instructionContainer'>
					...
					<div id='block17' className='instructionItem'>
						<ul>
							...
							<li className='ingredient'>3 tablespoon olive oil (divided)</li>
							<li className='ingredient'>2 limes , juiced and zested</li>
							<li className='ingredient'>1/4 cup chopped cilantro leaves </li>
							<li className='ingredient'>3 cloves garlic, minced</li>
							<li className='ingredient'>1 teaspoon ground cumin </li>
							<li className='ingredient'>1/2 teaspoon chili powder </li>
							<li className='ingredient'>1/2 teaspoon salt </li>
							<li className='ingredient'>1/4 teaspoon black pepper </li>
							<li className='ingredient'>4 cups romaine lettuce, chopped </li>
							<li className='ingredient'>1 1/2 cup cherry tomatoes, halved </li>
							<li className='ingredient'>
								1 cup black beans, rinsed and drained
							</li>
							<li className='ingredient'>1 cup corn, rinsed and drained </li>
							<li className='ingredient'>1/3 cup red onion , thinly sliced </li>
							<li className='ingredient'>1/2 large avocado </li>
							<li className='ingredient'>1/4 cup olive oil </li>
							<li className='ingredient'>
							...
							<li className='ingredient'>1 lime, juiced </li>
					...
					<div id='block20' className='instructionItem'>
						<ol id='instructionList' className='instructions'>
							<li className='instruction'>
								In a mixing bowl, whisk together two tablespoons of olive oil,
								with the lime juice, cilantro, garlic, chili powder, cumin,
								salt, and pepper. You can also pulse in a food processor until
								it's combined.
							</li>
							<li className='instruction'>
								Combine the marinade and chicken fillets in a shallow dish or
								plastic bag. Marinate the chicken for 2-6 hours in the fridge.
							</li>
							<li className='instruction'>
								When the chicken is done marinating, make the avocado dressing.
								Place all the dressing ingredients to a food processor and blend
								until creamy. Set aside.
							</li>
							<li className='instruction'>
								Heat the remaining one tablespoon of olive oil in a large
								skillet over medium-high heat. Then sear the chicken for 4-5
								minutes on each side, until they're golden brown and have
								reached an internal temperature of 160 degrees fahrenheit.
							</li>
							<li className='instruction'>
								Let the cooked chicken rest for a couple of minutes. Then slice
								into strips.
							</li>
							<li className='instruction'>
								In a large salad bowl, layer the chopped lettuce with beans,
								corn, tomatoes and chicken strips. Then drizzle the avocado
								dressing on top.
							</li>
						</ol>
					</div>
					...
					<div id='block22' className='instructionItem'>
						<div id='nutritionList'>
							...
							<div className='nutritionItem'>Calories: 518kcal |&nbsp;</div>
							<div className='nutritionItem'>Carbohydrates: 32g |&nbsp;</div>
							<div className='nutritionItem'>Protein: 31g |&nbsp;</div>
							<div className='nutritionItem'>Fat: 32g |&nbsp;</div>
							<div className='nutritionItem'>Saturated Fat: 5g |&nbsp;</div>
							<div className='nutritionItem'>Cholesterol: 72mg |&nbsp;</div>
							<div className='nutritionItem'>Sodium: 441mg |&nbsp;</div>
							<div className='nutritionItem'>Potassium: 1063mg |&nbsp;</div>
							<div className='nutritionItem'>Fiber: 9g |&nbsp;</div>
							<div className='nutritionItem'>Sugar: 5g |&nbsp;</div>
							<div className='nutritionItem'>Vitamin A: 4539U |&nbsp;</div>
							<div className='nutritionItem'>Vitamin C: 33mg |&nbsp;</div>
							<div className='nutritionItem'>Calcium: 71mg |&nbsp;</div>
...
export default SouthwestChickenSalad;
